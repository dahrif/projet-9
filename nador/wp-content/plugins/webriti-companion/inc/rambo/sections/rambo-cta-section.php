 ...
 */
if ( ! function_exists( 'webriti_rambo_cta' ) ) :

	function webriti_rambo_cta() {
...
if ( function_exists( 'webriti_rambo_cta' ) ) {
$section_priority = apply_filters( 'honeypress_section_priority', 11, 'webriti_rambo_cta' );
add_action( 'rambo_business_template_sections', 'webriti_rambo_cta', absint( $section_priority ) );
}